...
export const projects: Project[] = [
  {
    ...
    whatBuilt: [
      "RK4-based null geodesic integration pipeline for lightlike trajectories",
      "Image rendering workflow with multithreaded execution",
    ],
    ...
    visuals: [{ src: "/projects/schwarzschild-ray-tracer.jpg", alt: "Schwarzschild ray tracer rendered output" }],
  },
  {
    ...
    visuals: [{ src: "/projects/2d-physics-demo.gif", alt: "2D physics engine simulation preview" }],
  },
  {
    slug: "rfp-scraper",
    ...
    visuals: [{ src: "/projects/rfp-scraper.png", alt: "RFP scraper desktop application screenshot" }],
  },
  {
    ...
    visuals: [{ src: "/projects/calendar-screenshot.png", alt: "Student calendar application screenshot" }],
  },
  {
    ...
    visuals: [{ src: "/projects/personal-website.png", alt: "Portfolio project preview" }],
  },
];
